...
function TextToSpeech() {
    ...
    return (
        ...
        <>
            ...
            <div className="main-container d-flex flex-column flex-md-row h-100">
                ...
                <div className="gen-sound w-100 w-md-2/3 p-4 bg-light h-100">
                    <div className="gen-sound2 h-100 d-flex justify-content-center align-items-center">
                        {isLoading ? (
