...
import Navbar from "./ContentGeneration/components/Navbar/Navbar";
import DefaultIdeas from "./ContentGeneration/components/DefaultIdea/DefaultIdeas";
import UserQuery from "./ContentGeneration/components/UserInput/UserQuery";
import GptIntro from "./ContentGeneration/components/Ui/GptIntro";
import { IonIcon, setupIonicReact } from "@ionic/react";
import { menuOutline, addOutline } from "ionicons/icons";
import Header from "./ContentGeneration/components/Header/Header";
import useChat, { chatsLength, useAuth, useTheme } from "./ContentGeneration/store/store";
import classNames from "classnames";
import Chats from "./ContentGeneration/components/Chat/Chats";
import Modal from "./ContentGeneration/components/modals/Modal";
import Apikey from "./ContentGeneration/components/modals/Apikey";
